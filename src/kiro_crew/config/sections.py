...
class AgentConfig:
    ...
    sandbox: str = field(
        ...
        metadata=_meta(
            ...
            "to also hide ~/.aws, ~/.ssh (except known_hosts), ~/.kube and "
            "~/.config/gh from every agent subprocess -- opt-in, and it breaks "
            "those tools inside the agent for the same reason. 'strict' changes "
